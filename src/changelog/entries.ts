...
export const CHANGELOG_ENTRIES: readonly ChangelogEntry[] = [
    ...
    },
    {
        ...
        category: "support",
        text: {
            en: "Avylet A1 recordings with GPS show routes and speed.",
            ru: "Для записей Avylet A1 с GPS доступны маршрут и скорость.",
            de: "Avylet-A1-Aufnahmen mit GPS zeigen Route und Geschwindigkeit.",
            es: "Las grabaciones de Avylet A1 con GPS muestran la ruta y la velocidad.",
            fr: "Les enregistrements Avylet A1 avec GPS affichent l’itinéraire et la vitesse.",
            pl: "Nagrania z Avylet A1 z GPS pokazują trasę i prędkość.",
            pt: "As gravações da Avylet A1 com GPS mostram a rota e a velocidade.",
            zh: "带 GPS 的 Avylet A1 录像可显示路线和速度。",
            ja: "GPS 付きの Avylet A1 の録画でルートと速度を表示できます。",
            ko: "GPS가 있는 Avylet A1 녹화에서 경로와 속도를 볼 수 있어요.",
        },
    },
    {
        id: "2026-09-19.2",
        category: "fix",
        text: {
            en: "Raster maps no longer appear blurry on high-resolution screens.",
            ru: "Растровые карты больше не выглядят размытыми на экранах высокого разрешения.",
            de: "Rasterkarten erscheinen auf hochauflösenden Bildschirmen nicht mehr unscharf.",
            es: "Los mapas ráster ya no se ven borrosos en pantallas de alta resolución.",
            fr: "Les cartes raster ne sont plus floues sur les écrans haute résolution.",
            pl: "Mapy rastrowe nie są już rozmyte na ekranach o wysokiej rozdzielczości.",
            pt: "Os mapas raster não aparecem mais borrados em telas de alta resolução.",
            zh: "栅格地图在高分辨率屏幕上不再模糊。",
            ja: "高解像度の画面でラスター地図がぼやけなくなりました。",
            ko: "고해상도 화면에서 래스터 지도가 흐릿하게 보이지 않아요.",
        },
    },
    {
        id: "2026-09-19.1",
        category: "fix",
        text: {
            en: "Speed-colored routes no longer blend into roads.",
            ru: "Маршрут с окраской по скорости больше не сливается с дорогами.",
            de: "Nach Geschwindigkeit eingefärbte Routen verschwimmen nicht mehr mit den Straßen.",
            es: "Las rutas coloreadas según la velocidad ya no se confunden con las carreteras.",
            fr: "Les itinéraires colorés selon la vitesse ne se confondent plus avec les routes.",
            pl: "Trasy kolorowane według prędkości nie zlewają się już z drogami.",
            pt: "As rotas coloridas por velocidade não se confundem mais com as vias.",
            zh: "按速度着色的路线不再与道路混在一起。",
            ja: "速度で色分けしたルートが道路に紛れなくなりました。",
            ko: "속도별로 색이 표시된 경로가 도로와 구분돼요.",
        },
    },
    {
        id: "2026-09-18.6",
        category: "fix",
        text: {
            en: "Canceling an export no longer reports a save error.",
            ru: "Отмена экспорта больше не вызывает ошибку сохранения.",
            de: "Beim Abbrechen eines Exports erscheint kein Speicherfehler mehr.",
            es: "Cancelar una exportación ya no muestra un error de guardado.",
            fr: "Annuler un export n’affiche plus d’erreur d’enregistrement.",
            pl: "Anulowanie eksportu nie powoduje już błędu zapisu.",
            pt: "Cancelar uma exportação não exibe mais um erro ao salvar.",
            zh: "取消导出不再提示保存错误。",
            ja: "書き出しをキャンセルしても保存エラーが表示されなくなりました。",
            ko: "내보내기를 취소해도 저장 오류가 표시되지 않아요.",
        },
    },
    {
        id: "2026-09-18.5",
    ...
    },
    {
        ...
        category: "feature",
        text: {
            en: "Choose the map's appearance and provider, including Yandex where available.",
            ru: "Можно выбрать оформление и источник карты, включая Яндекс Карты, если они доступны.",
            de: "Wähle Kartenstil und Anbieter, einschließlich Yandex Maps, falls verfügbar.",
            es: "Elige el estilo y el proveedor del mapa, incluido Yandex Maps donde esté disponible.",
            fr: "Choisis le style et le fournisseur de la carte, dont Yandex Maps si disponible.",
            pl: "Wybierz styl i dostawcę mapy, w tym Yandex Maps, jeśli jest dostępny.",
            pt: "Escolha o estilo e o provedor do mapa, incluindo Yandex Maps quando disponível.",
            zh: "可选择地图样式和提供方，Yandex 地图在可用时也可选择。",
            ja: "地図のスタイルと提供元を選べます。利用可能な場合は Yandex Maps も選べます。",
            ko: "지도 스타일과 제공업체를 선택할 수 있어요. 이용 가능한 경우 Yandex Maps도 선택할 수 있어요.",
        },
    },
    {
        id: "2026-09-18.3",
        category: "feature",
        text: {
            en: "Reflect each camera horizontally or vertically during playback and export.",
            ru: "Изображение каждой камеры можно отразить по горизонтали или вертикали при просмотре и экспорте.",
            de: "Spiegle jede Kamera bei Wiedergabe und Export horizontal oder vertikal.",
            es: "Refleja cada cámara horizontal o verticalmente durante la reproducción y la exportación.",
            fr: "Inverse chaque caméra horizontalement ou verticalement pendant la lecture et l’export.",
            pl: "Odbij obraz każdej kamery w poziomie lub w pionie podczas odtwarzania i eksportu.",
            pt: "Espelhe cada câmera na horizontal ou vertical durante a reprodução e a exportação.",
            zh: "播放和导出时可分别水平或垂直翻转每台摄像头的画面。",
            ja: "再生時と書き出し時に、カメラごとに映像を左右または上下に反転できます。",
            ko: "재생과 내보내기에서 카메라별로 영상을 좌우 또는 상하로 반전할 수 있어요.",
        },
    },
    {
        id: "2026-09-18.2",
        category: "fix",
        text: {
            en: "DDPAI Z60 Pro previews no longer appear as duplicate recordings.",
            ru: "Миниатюры DDPAI Z60 Pro больше не отображаются как повторные записи.",
            de: "Vorschauen der DDPAI Z60 Pro erscheinen nicht mehr als doppelte Aufnahmen.",
            es: "Las vistas previas de DDPAI Z60 Pro ya no aparecen como grabaciones duplicadas.",
            fr: "Les aperçus DDPAI Z60 Pro n’apparaissent plus comme des enregistrements en double.",
            pl: "Podglądy DDPAI Z60 Pro nie pojawiają się już jako zduplikowane nagrania.",
            pt: "As prévias da DDPAI Z60 Pro não aparecem mais como gravações duplicadas.",
            zh: "DDPAI Z60 Pro 的预览文件不再显示为重复录像。",
            ja: "DDPAI Z60 Pro のプレビューが重複した録画として表示されなくなりました。",
            ko: "DDPAI Z60 Pro 미리보기가 중복 녹화로 표시되지 않아요.",
        },
    },
    {
        id: "2026-09-18.1",
        category: "fix",
        text: {
            en: "Some MP4 recordings that failed to export can be saved.",
            ru: "Некоторые записи MP4, которые раньше не экспортировались, теперь можно сохранить.",
            de: "Einige MP4-Aufnahmen, deren Export fehlschlug, lassen sich speichern.",
            es: "Se pueden guardar algunas grabaciones MP4 que fallaban al exportarse.",
            fr: "Certains enregistrements MP4 dont l’export échouait peuvent être enregistrés.",
            pl: "Można zapisać niektóre nagrania MP4, których eksport wcześniej się nie udawał.",
            pt: "Algumas gravações MP4 que falhavam na exportação podem ser salvas.",
            zh: "部分先前导出失败的 MP4 录像现在可以保存。",
            ja: "書き出しに失敗していた一部の MP4 録画を保存できるようになりました。",
            ko: "내보내기에 실패하던 일부 MP4 녹화를 저장할 수 있어요.",
        },
    },
    {
        id: "2026-09-17.1",
        category: "fix",
        text: {
            en: "Recordings from some multi-camera devices no longer split into separate trips.",
            ru: "Записи некоторых многокамерных устройств больше не разделяются на разные поездки.",
            de: "Aufnahmen einiger Geräte mit mehreren Kameras werden nicht mehr auf getrennte Fahrten verteilt.",
            es: "Las grabaciones de algunos dispositivos con varias cámaras ya no se separan en distintos trayectos.",
            fr: "Les enregistrements de certains appareils à plusieurs caméras ne sont plus répartis entre plusieurs trajets.",
            pl: "Nagrania z niektórych urządzeń z wieloma kamerami nie dzielą się już na osobne przejazdy.",
            pt: "As gravações de alguns dispositivos com várias câmeras não são mais divididas em viagens separadas.",
            zh: "部分多摄像头设备的录像不再被拆分为不同的行程。",
            ja: "一部の複数カメラ搭載機器の録画が、別々の走行に分かれなくなりました。",
            ko: "일부 다중 카메라 기기의 녹화가 별도 주행으로 나뉘지 않아요.",
        },
    },
    {
        id: "2026-09-16.3",
    ...
    },
    {
        ...
        text: {
            ...
            zh: "导出时会保留点数较多的轨迹中的 GPS 数据。",
            ja: "点数の多い GPS トラックのデータも書き出し時に保持されます。",
