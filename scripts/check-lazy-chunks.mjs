...
// growth before a deliberate bump is needed. The timeline navigator and export
// trim accessibility work bring the intentional total to ~729KB; 744KB keeps
// useful app-growth headroom while remaining far below a heavy-lib leak.
const EAGER_TOTAL_JS_BUDGET_BYTES = 744 * 1024;
