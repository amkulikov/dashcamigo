...
// growth before a deliberate bump is needed. Current staging total is ~701KB;
// 710KB leaves useful app-growth headroom while remaining far below a heavy-lib
// leak.
const EAGER_TOTAL_JS_BUDGET_BYTES = 710 * 1024;
