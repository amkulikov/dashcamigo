...
const FEATURE_PAGES: FeaturePage[] = [
    ...
    },
    {
        ...
        locales: {
            ...
            ru: {
                title: "Замазать номер машины и лица на видео регистратора — бесплатно, в браузере | dashcamigo",
                metaDescription:
                    "Замажь или запиксели номера машин и лица на видео с регистратора перед отправкой — бесплатно, в браузере, ничего не загружается. Плашка сама следует за объектом и впечатывается в файл.",
                ogTitle: "Замазать номера и лица на видео регистратора — бесплатно",
                ogDescription:
                ...
                lead: "Выложить запись с регистратора обычно значит показать чей-то номер — или лицо прохожего — всему интернету. dashcamigo закрывает их до отправки: нарисуй рамку поверх номера или лица, дай ей проследить за объектом в кадре и сохрани ролик — плашка впечатана в картинку. Всё в браузере, так что видео не покидает твоё устройство.",
